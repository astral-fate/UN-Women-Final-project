      ...
      <div class="container">
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown dropdown-center user-dropdown">
            ...
            <img class="img-md rounded-circle" src="{{ asset('assests/images/' . (Auth::user()->avatar ?? 'avatar-default.svg')) }}" alt="Profile image"
            </a>
            <div class="dropdown-menu dropdown-center navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{ Auth::user()->avatar ?? 'assests/images/avatar-default.svg' }}" alt="Profile image"
                  width="80" height="80" />
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              <a class="nav-link active dropdown-toggle" href="{{ route('admin.users.index') }}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                USERS
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="{{ route('admin.topics.index') }}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                TOPICS
              </a>
              <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="{{ route('admin.testimonials.index') }}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                TESTIMONIALS
              </a>
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="{{ route('admin.testimonials.index') }}">All testimonials</a>
                </li>
              </ul>
            </li>
            <li><a class="nav-item nav-link" href="{{ route('admin.messages.index') }}">MESSAGES</a></li>
          </ul>
        </div>
      </div>
    </nav>
